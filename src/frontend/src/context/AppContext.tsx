...
const FULL_COURSES: Course[] = [
  ...
  // Computer Science Education (dept 25) - BSc Ed - Federal University of Education, Kontagora
  // 100L First Semester
  {
    id: BigInt(132),
  ...
  {
    id: BigInt(134),
    name: "Introduction to Teaching and Foundation of Education",
    code: "EDU101",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1327),
    name: "General Mathematics II (Calculus)",
    code: "MTH102",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1328),
    name: "Conic Section and App. Of Calculus",
    code: "MTH104",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1329),
    name: "Fundamentals of E-Learning",
    code: "COS104",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1331),
    name: "Environmental and Sustainable Development",
    code: "GST211",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1333),
    name: "Curriculum, Curriculum Delivery and Teaching Methods",
    code: "EDU201",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1334),
    name: "Educational Technology and Artificial Intelligence",
    code: "EDU203",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1342),
    name: "Micro Teaching (Theory and Practice)",
    code: "EDU202",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1343),
    name: "Methods of Teaching Computer Science I",
    code: "SED202",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1345),
    name: "Statistics for Physical Science and Engineering",
    code: "STA202",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1353),
    name: "Research Methodology and Data Analysis",
    code: "SED301",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1356),
    name: "Introduction to Cyber Security and Strategy",
    code: "CBY301",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1357),
    name: "Data Communication System and Networks",
    code: "ICT305",
    creditUnits: BigInt(3),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1363),
    name: "Methods of Teaching Computer Science II",
    code: "SED302",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1365),
    name: "Computer Science Innovation and New Technologies",
    code: "CSC322",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1367),
    name: "E-Learning Design and Development",
    code: "COS302",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1368),
    name: "Programming for Educational Apps",
    code: "COS304",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1370),
    name: "Seminar in Computer Science and Education",
    code: "SED401",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1374),
    name: "Professional and Social Aspect of Computing",
    code: "COS403",
    creditUnits: BigInt(3),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1378),
    name: "Organization and Management of Computer Laboratory",
    code: "SED402",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1380),
    name: "Emerging ICT Trends in Education",
    code: "SED406",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1381),
    name: "Ethics and Legal Issues in Computer Science",
    code: "CSC402",
    creditUnits: BigInt(2),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
  ...
  {
    id: BigInt(1383),
    name: "Online Learning Management Systems",
    code: "COS406",
    creditUnits: BigInt(3),
    departmentId: BigInt(25),
    lecturerPrincipal: "lecturer-3",
